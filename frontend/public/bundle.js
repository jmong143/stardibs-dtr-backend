...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsIndex = __webpack_require__(201);

	//child

	var _componentsIndex2 = _interopRequireDefault(_componentsIndex);

	var _componentsDashboard = __webpack_require__(202);

	//child

	var _componentsDashboard2 = _interopRequireDefault(_componentsDashboard);

	var _componentsUserLists = __webpack_require__(203);

	//child

	var _componentsUserLists2 = _interopRequireDefault(_componentsUserLists);

	var _componentsCreateUser = __webpack_require__(1);

	//child

	var _componentsCreateUser2 = _interopRequireDefault(_componentsCreateUser);

	var _componentsViewRecord = __webpack_require__(204);

	//child

	var _componentsViewRecord2 = _interopRequireDefault(_componentsViewRecord);

	var _componentsManualDTR = __webpack_require__(205);

	//child

	var _componentsManualDTR2 = _interopRequireDefault(_componentsManualDTR);

	var _componentsBirthdayCorner = __webpack_require__(206);

	//child

	var _componentsBirthdayCorner2 = _interopRequireDefault(_componentsBirthdayCorner);

	var _componentsDTRModel = __webpack_require__(207);

	//child

	var _componentsDTRModel2 = _interopRequireDefault(_componentsDTRModel);

	var _componentsWhoops404 = __webpack_require__(208);
	...
	var routes = _react2['default'].createElement(
		...
		_react2['default'].createElement(DefaultRoute, { handler: _componentsIndex2['default'] }),
		_react2['default'].createElement(Route, { name: "index", path: "index", handler: _componentsIndex2['default'] }),
		_react2['default'].createElement(Route, { name: "dashboard", path: "dashboard", handler: _componentsDashboard2['default'] }),
		_react2['default'].createElement(Route, { name: "manual-dtr", path: "manual-dtr", handler: _componentsManualDTR2['default'] }),
		_react2['default'].createElement(Route, { name: "users-list", path: "users-list", handler: _componentsUserLists2['default'] }),
		_react2['default'].createElement(Route, { name: "view-record", path: "view-record", handler: _componentsViewRecord2['default'] }),
		_react2['default'].createElement(Route, { name: "birthday-corner", path: "birthday-corner", handler: _componentsBirthdayCorner2['default'] }),
		_react2['default'].createElement(Route, { name: "model", path: "model", handler: _componentsDTRModel2['default'] }),
		_react2['default'].createElement(Route, { name: "create-user", path: "create-user", handler: _componentsCreateUser2['default'] }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partsUserHeader = __webpack_require__(158);

	var _partsUserHeader2 = _interopRequireDefault(_partsUserHeader);

	var _partsModal = __webpack_require__(198);

	var _partsModal2 = _interopRequireDefault(_partsModal);
	...
	var CreateUser = (function (_React$Component) {
	  ...
	  function CreateUser() {
	    ...
	    _get(Object.getPrototypeOf(CreateUser.prototype), 'constructor', this).call(this);
	    this.state = {
	      txtUsername: '',
	      txtFirstName: '',
	      txtLastName: '',
	  ...
	  _createClass(CreateUser, [{
	    ...
	    value: function render() {
	      ...
	      if (localStorage.getItem("dtrCurrentUser") === null) {
	        ...
	        return _react2['default'].createElement(
	          'div',
	          { id: "" },
	          _react2['default'].createElement(_partsUserHeader2['default'], { currentUser: currentUser }),
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  'h3',
	                  { className: "panel-title text-primary" },
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  'form',
	                  { action: "javascript:void(0)", onSubmit: function () {
	                      return _this.createUserProcess();
	                    } },
	                  _react2['default'].createElement(
	                    'div',
	                    ...
	                    _react2['default'].createElement('input', { type: "text", className: "form-control", placeholder: "Input Username", name: "username", value: this.state.txtUsername, onChange: function (e) {
	                        return _this.handleUsername(e);
	                      } })
	                  ),
	                  _react2['default'].createElement(
	                    'div',
	                    ...
	                    _react2['default'].createElement('input', { type: "password", className: "form-control", placeholder: "Input Password", name: "password", value: this.state.txtPassword, onChange: function (e) {
	                        return _this.handlePassword(e);
	                      } })
	                  ),
	                  _react2['default'].createElement(
	                    'div',
	                    ...
	                    _react2['default'].createElement('input', { type: "text", className: "form-control", placeholder: "Input First Name", name: "first_name", value: this.state.txtFirstName, onChange: function (e) {
	                        return _this.handleFirstName(e);
	                      } })
	                  ),
	                  _react2['default'].createElement(
	                    'div',
	                    ...
	                    _react2['default'].createElement('input', { type: "text", className: "form-control", placeholder: "Input Last Name", name: "last_name", value: this.state.txtLastName, onChange: function (e) {
	                        return _this.handleLastName(e);
	                      } })
	                  ),
	                  _react2['default'].createElement(
	                    'div',
	                    ...
	                    _react2['default'].createElement('input', { type: "text", className: "form-control", placeholder: "Input Email", name: "email", value: this.state.txtEmail, onChange: function (e) {
	                        return _this.handleEmail(e);
	                      } })
	                  ),
	                  _react2['default'].createElement(
	                    'div',
	                    ...
	                    _react2['default'].createElement(
	                      'select',
	                      { className: "form-control", name: "position", value: this.state.txtPosition, onChange: function (e) {
	                          return _this.handlePosition(e);
	                        } },
	          ...
	          _react2['default'].createElement('div', { className: "col-md-2" }),
	          _react2['default'].createElement(_partsModal2['default'], { currentUser: currentUser })
	        );
	      }
	    }
	  }, {
	    ...
	    key: 'createUserProcess',
	    value: function createUserProcess() {
	      var THIS = this;
	      $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserHeader = (function (_React$Component) {
	  ...
	  function UserHeader() {
	    ...
	    _get(Object.getPrototypeOf(UserHeader.prototype), 'constructor', this).call(this);
	    this.state = {
	      fullname: '',
	      email: '',
	      userType: '',
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              _reactRouter.Link,
	              { to: "/dashboard", className: "navbar-brand" },
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              currentUser['user'].userType == "admin" ? _react2['default'].createElement(
	                'li',
	                null,
	                _react2['default'].createElement(
	                  _reactRouter.Link,
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  'a',
	                  { href: "#", 'data-toggle': "modal", 'data-target': "#modalLogout" },
		...
		_createClass(Modal, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'div',
						{ id: "modalLogout", className: "modal fade", role: "dialog" },
						_react2['default'].createElement(
							'div',
							...
							_react2['default'].createElement(
								...
								_react2['default'].createElement(
									...
									_react2['default'].createElement(
										...
										_react2['default'].createElement(
											'center',
											null,
											_react2['default'].createElement('img', { src: "./assets/img/logout.gif", className: "img-responsive" })
										),
										'   '
									)
								),
								_react2['default'].createElement(
									...
									_react2['default'].createElement(
										'button',
										{ type: "button", id: "btnTimeInCancel", className: "btn btn-warning", 'data-dismiss': "modal" },
					...
					_react2['default'].createElement(
						'div',
						{ id: "modalChangePassword", className: "modal fade", role: "dialog" },
						_react2['default'].createElement(
							'div',
							{ className: "modal-dialog" },
							_react2['default'].createElement(
								...
								_react2['default'].createElement(
									...
									_react2['default'].createElement(
										...
										_react2['default'].createElement(
											...
											_react2['default'].createElement('input', { type: "text", className: "form-control", placeholder: "New Password", onChange: function (e) {
													return _this.handleNewPass(e);
												} })
										),
										_react2['default'].createElement(
											'button',
					...
					_react2['default'].createElement(
						'div',
						{ id: "modalEditProfile", className: "modal fade", role: "dialog" },
						_react2['default'].createElement(
							'div',
							{ className: "modal-dialog" },
							_react2['default'].createElement(
								...
								_react2['default'].createElement(
									...
									_react2['default'].createElement(
										...
										_react2['default'].createElement(
											...
											_react2['default'].createElement('input', { type: "text", className: "form-control", placeholder: "First Name", value: this.state.txtFirstName, onChange: function (e) {
													return _this.handleFirstName(e);
												} })
										),
										_react2['default'].createElement(
											...
											_react2['default'].createElement('input', { type: "text", className: "form-control", placeholder: "Last Name", value: this.state.txtLastName, onChange: function (e) {
													return _this.handleLastName(e);
												} })
										),
										_react2['default'].createElement(
											...
											_react2['default'].createElement('input', { type: "text", className: "form-control", placeholder: "Email", value: this.state.txtEmail, onChange: function (e) {
													return _this.handleEmail(e);
												} })
										),
										_react2['default'].createElement(
					...
					_react2['default'].createElement(
						'div',
						{ id: "modalTimeIn", className: "modal fade", role: "dialog" },
						_react2['default'].createElement(
							'div',
							{ className: "modal-dialog" },
							_react2['default'].createElement(
								...
								_react2['default'].createElement(
									...
									_react2['default'].createElement(
										...
										_react2['default'].createElement(
											'center',
											null,
											_react2['default'].createElement('img', { src: "./assets/img/work-in.gif", className: "img-responsive" })
										),
										'   '
									)
								),
					...
					_react2['default'].createElement(
						'div',
						{ id: "modalTimeOut", className: "modal fade", role: "dialog" },
						_react2['default'].createElement(
							'div',
							{ className: "modal-dialog" },
							_react2['default'].createElement(
								...
								_react2['default'].createElement(
									...
									_react2['default'].createElement(
										...
										_react2['default'].createElement(
											'center',
											null,
											_react2['default'].createElement('img', { src: "./assets/img/work-out.gif", className: "img-responsive" })
										),
										'   '
									)
								),
								_react2['default'].createElement(
									...
									_react2['default'].createElement(
										'button',
										{ type: "button", id: "btnTimeOutCancel", className: "btn btn-warning", 'data-dismiss': "modal" },
										_react2['default'].createElement('span', { className: "glyphicon glyphicon-ban-circle" }),
										' No'
									)
								)
			...
			key: 'timeInProcess',
			value: function timeInProcess() {
				var currentUser = this.props.currentUser;
				var currentdate = new Date();
				var timeIn = currentdate.getHours() + ":" + currentdate.getMinutes() + ":" + currentdate.getSeconds();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partsHeader = __webpack_require__(200);
	    ...
	    _createClass(APP, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                'div',
	                null,
	                _react2['default'].createElement(_partsHeader2['default'], null),
		...
		_createClass(Header, [{
			...
			value: function render() {
				return _react2["default"].createElement(
					...
					_react2["default"].createElement("img", { src: "./assets/img/stardibs-banner.png", className: "img-responsive" }),
					_react2["default"].createElement(
						"center",
						null,
						_react2["default"].createElement("img", { src: "./assets/img/logo.png", className: "img-responsive" })
					),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Speaker = (function (_React$Component) {
		...
		function Speaker() {
			...
			_get(Object.getPrototypeOf(Speaker.prototype), 'constructor', this).call(this);
			this.state = {
				username: '',
				password: ''
			};
		...
		_createClass(Speaker, [{
								...
								_react2['default'].createElement(
									...
									_react2['default'].createElement(
										...
										_react2['default'].createElement(
											...
											_react2['default'].createElement('span', { className: "glyphicon glyphicon-time" }),
											_react2['default'].createElement('span', { id: 'displaytime' }),
											' Date Time Record'
										)
									),
									_react2['default'].createElement(
										...
										_react2['default'].createElement(
											...
											_react2['default'].createElement(
												...
												_react2['default'].createElement('input', { type: "text", name: "Username", className: "form-control", value: this.state.username, onChange: function (e) {
														return _this.handleUsername(e);
													} }),
												_react2['default'].createElement(
													'h5',
												...
												_react2['default'].createElement('input', { type: "password", name: "password", className: "form-control", value: this.state.password, onChange: function (e) {
														return _this.handlePassword(e);
													} }),
												_react2['default'].createElement('br', null),
												_react2['default'].createElement(
													...
													_react2['default'].createElement(
														'button',
														{ className: "btn btn-lg btn-primary", onClick: function () {
																return _this.loginProcess(_this.state.username, _this.state.password);
															} },
														'Login'
													),
													'  ',
													_react2['default'].createElement(
														'button',
														{ className: "btn btn-lg btn-warning", onClick: function () {
			...
			key: 'loginProcess',
			value: function loginProcess(username, password) {
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  ...
	                  _react2['default'].createElement(
	                    'a',
	                    { 'data-toggle': "modal", 'data-target': "#modalTimeIn", className: "btn btn-primary btnLarge" },
	                    _react2['default'].createElement('span', { className: "glyphicon glyphicon-ok" }),
	                    ' Time In '
	                  ),
	                  '  ',
	                  _react2['default'].createElement(
	                    'a',
	                    { 'data-toggle': "modal", 'data-target': "#modalTimeOut", className: "btn btn-danger btnLarge" },
	                    _react2['default'].createElement('span', { className: "glyphicon glyphicon-off" }),
	                    ' Time Out '
	                  )
	                )
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement('img', { src: currentUser['user'].avatar, className: "img-responsive" }),
	              _react2['default'].createElement(
	                'h5',
	                null,
	                'Position: ',
	              ...
	              _react2['default'].createElement(
	                'a',
	                { 'data-toggle': "modal", 'data-target': "#modalEditProfile", className: "btn btn-success" },
	              ...
	              _react2['default'].createElement(
	                'a',
	                { 'data-toggle': "modal", 'data-target': "#modalChangePassword", className: "btn btn-primary" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserLists = (function (_React$Component) {
	  ...
	  function UserLists() {
	    ...
	    _get(Object.getPrototypeOf(UserLists.prototype), 'constructor', this).call(this);
	    this.state = {
	      userList: [],
	      userDetailsEmail: '',
	      userDetailsFullName: '',
	  ...
	  _createClass(UserLists, [{
	    ...
	    key: 'viewUserData',
	    value: function viewUserData(id) {
	      var THIS = this;
	      $.ajax({
	    ...
	    value: function render() {
	      var THIS = this;
	      var renderData = typeof this.state.userList.data == 'undefined' ? '' : this.state.userList.data.map(function (list) {
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              { className: "btn btn-info", onClick: function () {
	                  return THIS.viewUserData(list._id);
	                } },
	              _react2['default'].createElement('span', { className: "glyphicon glyphicon-eye-open" }),
	              ' View'
	            ),
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                'p',
	                { id: "defaultViewText" },
	                'Click view button to show user details'
	              ),
	              _react2['default'].createElement(
	                'div',
	                { id: "userDetails", className: "hidden" },
	                _react2['default'].createElement(
	                  'p',
	                  null,
	                  ' ',
	                  _react2['default'].createElement(
	                    'center',
	                    null,
	                    _react2['default'].createElement('img', { src: THIS.state.userDetailsAvatar, className: "img-responsive" })
	                  ),
	                  '   '
	                ),
	                _react2['default'].createElement(
	                  ...
	                  null,
	                  'Name: ',
	                  THIS.state.userDetailsFullName
	                ),
	                _react2['default'].createElement(
	                  'p',
	                  null,
	                  'Username: ',
	                  THIS.state.userDetailsUsername
	                ),
	                _react2['default'].createElement(
	                  'p',
	                  null,
	                  'Email: ',
	                  THIS.state.userDetailsEmail
	                ),
	                _react2['default'].createElement(
	                  'p',
	                  null,
	                  'Position: ',
	                  THIS.state.userDetailsPosition
	                )
	              )
	            )
	          ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ViewRecord = (function (_React$Component) {
	  ...
	  function ViewRecord() {
	    ...
	    _get(Object.getPrototypeOf(ViewRecord.prototype), 'constructor', this).call(this);
	    this.state = {
	      renderDTRData: []
	    };
	  }
	  ...
	  _createClass(ViewRecord, [{
	    ...
	    key: 'retrieveUserDTR',
	    value: function retrieveUserDTR() {
	      var THIS = this;
	      var currentUser = JSON.parse(localStorage.getItem("dtrCurrentUser"));
	      $.ajax({
	    ...
	    value: function render() {
	      ...
	      var renderDTRData = typeof this.state.renderDTRData.data == 'undefined' ? '' : this.state.renderDTRData.data.map(function (list) {
	        return _react2['default'].createElement(
	          'tr',
	          null,
	          _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'td',
	            null,
	            moment(list.timeIn, 'h:mm a').format('h:mm a')
	          ),
	          _react2['default'].createElement(
	            'td',
	            null,
	            list.timeOut == "--" ? '--' : moment(list.timeOut, 'h:mm a').format('h:mm a')
	          ),
	          _react2['default'].createElement(
	            'td',
	            null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ManualDTR = (function (_React$Component) {
	  _inherits(ManualDTR, _React$Component);

	  function ManualDTR() {
	    _classCallCheck(this, ManualDTR);

	    _get(Object.getPrototypeOf(ManualDTR.prototype), 'constructor', this).call(this);
	    this.state = {
	      checkTimeInStatus: [],
	      timeInCurrentDate: '',
	      timeInCurrentIn: '',
	  ...
	  _createClass(ManualDTR, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      this.checkTimeInStatus();
	    }
	  }, {
	    key: 'checkTimeInStatus',
	    value: function checkTimeInStatus() {
	      var THIS = this;
	      var currentUser = JSON.parse(localStorage.getItem("dtrCurrentUser"));
	      $.ajax({
	        url: 'http://localhost:5008/dtr-api/time-record/basic-search',
	    ...
	    key: 'handleManualTimeOut',
	    value: function handleManualTimeOut(e) {
	      this.setState({ txtManualTimeOut: e.target.value });
	    }
	  }, {
	    key: 'submitManualTimeOut',
	    value: function submitManualTimeOut() {
	      var THIS = this;
	    ...
	    value: function render() {
	      ...
	      var renderTimeOutFields = _react2['default'].createElement(
	        'div',
	        { className: "alert alert-dismissible alert-danger" },
	        _react2['default'].createElement(
	          'form',
	          { action: "javascript:void(0)", onSubmit: function () {
	              return _this.submitManualTimeOut();
	            } },
	          _react2['default'].createElement(
	            'div',
	            { className: "form-group" },
	            ...
	            _react2['default'].createElement('input', { type: "text", placeholder: "Current Date", className: "form-control", value: this.state.timeInCurrentDate, disabled: true })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: "form-group" },
	            ...
	            _react2['default'].createElement('input', { type: "text", placeholder: "Current Date", className: "form-control", value: moment(this.state.timeInCurrentIn, 'h:mm a').format('h:mm a'), disabled: true })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: "form-group" },
	            ...
	            _react2['default'].createElement('input', { type: "time", placeholder: "Input Time Out", name: "txtManualTimeOut", value: this.state.txtManualTimeOut, onChange: function (e) {
	                return _this.handleManualTimeOut(e);
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  ...
	                  _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                      'a',
	                      { href: "#timeIn", 'data-toggle': "tab", 'aria-expanded': "true" },
	                      'Time In'
	                    )
	                  ),
	                  _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                      'a',
	                      { href: "#timeOut", 'data-toggle': "tab", 'aria-expanded': "false" },
	                      'Time Out'
	                    )
	                  )
	                ),
	                _react2['default'].createElement(
	                  ...
	                  _react2['default'].createElement(
	                    'div',
	                    { className: "tab-pane fade active in", id: "timeIn" },
	                    _react2['default'].createElement('br', null),
	                    _react2['default'].createElement(
	                      'div',
	                      { className: "alert alert-dismissible alert-danger" },
	                      _react2['default'].createElement(
	                        'form',
	                        { action: "javascript:void(0)", onSubmit: function () {
	                            return _this.submitManualTimeIn();
	                          } },
	                        _react2['default'].createElement(
	                          'div',
	                          { className: "form-group" },
	                          ...
	                          _react2['default'].createElement('input', { type: "date", className: "form-control", placeholder: "Select Date", onChange: function (e) {
	                              return _this.handleSelectDateIn(e);
	                            } })
	                        ),
	                        _react2['default'].createElement(
	                          'div',
	                          ...
	                          _react2['default'].createElement('input', { type: "time", className: "form-control", placeholder: "Time In", onChange: function (e) {
	                              return _this.handleSelectTimeIn(e);
	                            } })
	                        ),
	                        _react2['default'].createElement(
	                          'div',
	                          ...
	                          _react2['default'].createElement('input', { type: "time", className: "form-control", placeholder: "Time Out", onChange: function (e) {
	                              return _this.handleSelectTimeOut(e);
	                            } })
	                        ),
	                        _react2['default'].createElement(
	                          'button',
	                  ...
	                  _react2['default'].createElement(
	                    'div',
	                    { className: "tab-pane fade", id: "timeOut" },
	                    typeof this.state.checkTimeInStatus == 'undefined' || this.state.checkTimeInStatus.length == [] ? _react2['default'].createElement(
	                      'div',
	                      null,
	                      _react2['default'].createElement('br', null),
	                      _react2['default'].createElement(
	                        'div',
	                        { className: "alert alert-dismissible alert-info", id: "" },
	    ...
	    key: 'handleSelectDateIn',
	    value: function handleSelectDateIn(e) {
	      this.setState({ txtTimeOutDate: e.target.value });
	    }
	  }, {
	    key: 'handleSelectTimeIn',
	    value: function handleSelectTimeIn(e) {
	      this.setState({ txtTimeOutFirst: e.target.value });
	    }
	  }, {
	    key: 'handleSelectTimeOut',
	    value: function handleSelectTimeOut(e) {
	      this.setState({ txtTimeOutSecond: e.target.value });
	    }
	  }, {
	    key: 'submitManualTimeIn',
	    value: function submitManualTimeIn() {
	      var THIS = this;
	      var currentUser = JSON.parse(localStorage.getItem("dtrCurrentUser"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BirthdayCorner = (function (_React$Component) {
	  _inherits(BirthdayCorner, _React$Component);

	  function BirthdayCorner() {
	    _classCallCheck(this, BirthdayCorner);

	    _get(Object.getPrototypeOf(BirthdayCorner.prototype), 'constructor', this).call(this);
	    this.state = {};
	  }

	  _createClass(BirthdayCorner, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {}
	  }, {
	    key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DTRModel = (function (_React$Component) {
	  _inherits(DTRModel, _React$Component);

	  function DTRModel() {
	    _classCallCheck(this, DTRModel);

	    _get(Object.getPrototypeOf(DTRModel.prototype), 'constructor', this).call(this);
	    this.state = {};
	  }

	  _createClass(DTRModel, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {}
	  }, {
	    key: 'render',
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  'div',
	                  { className: "alert alert-dismissible alert-success col-md-12" },
	                  _react2['default'].createElement(
	                    'h4',
	                    null,
	                    'Model of the month currently empty'
	                  ),
	                  _react2['default'].createElement(
	                    'div',
	                  ...
	                  _react2['default'].createElement(
	                    'div',
	                    { className: "col-md-6 hidden" },
	                    _react2['default'].createElement('img', { src: "./assets/img/avatar/michael1.jpg", className: "img-responsive", style: { height: "300px" } })
	                  )
	                )
	              )
	            )
